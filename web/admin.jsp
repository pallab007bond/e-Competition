...
<tr>
<td height="107" align="center" style="padding-bottom:1em;">
    <a href="newexam.jsp"><button class="button button1">Add New Exam</button></a>
<td align="center" style="padding-bottom:1em;">
    <a href="newquiz.jsp"><button class="button button2">Add New Quiz</button></a>
</tr>
<tr>
<td  height="131" align="center" style="padding-bottom:1em;">
    <a href="students.jsp"><button class="button button3">Student Report</button></a></td>
<td  height="131" align="center" style="padding-bottom:1em;">
    <a href="delete.jsp"><button class="button button4">Remove Account</button></a></td>

</tr>
    </table></center>
    <center><table style="width:900px;font-size:20px;">
   <tr>
<td height="123" align="center" style="padding-bottom:1em;">
    <a href="newrules.jsp"><button class="button button5">View Rules</button></a></td>
 </tr>
</table></center>       
	<!-- footer -->
	<div class="footer">
