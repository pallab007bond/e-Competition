	...
	<div class="about">
		<div class="container"> 
			<div class="login-form">
                            ...
                            <form name="img" action="uploadpic.jsp" method="post" enctype="multipart/form-data">
                                        <div class="styled-input">
                                            Upload Image(Passport Size)<input type="file" name="pic"/><br/> 
                                        </div>
        ...
        <a href="index.jsp"><center><button class="button" style="vertical-align:middle"><span>Skip</span></button></center></a>
