...
<body>
    ...
    %> 
    <pre>
<center><table border="2" cellspacing="10px" style="width:900px;font-size:20px;">

<tr>
    <td width="200px"><b>Exam Name <b></td><td width="200px"><b>&nbsp;Company/Govt. Organization</b></td>
   <td><b>&nbsp;&nbsp;First Rule</b></td><td><b>Second Rule</b></td>
   <td><b>Third Rule</b></td>
   <td><b>Fourth Rule</b></td>
</tr>
<%
 try
 {
 con = ConnectionProvider.getConnection();
 PreparedStatement pstmt1 = con.prepareStatement("select * from examname");
 ...
 while(rset1.next())
 {
  ...
  <tr>
    ...
    <td><%=rset1.getString(3)%></td><td><%=rset1.getString(4)%></td><td><%=rset1.getString(5)%></td>
...
<center><a href="admin.jsp"><input type="button" class="button5" value="<< Back"></a></center>
