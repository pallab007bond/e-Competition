...
<!-- Banner -->
    <div style="color: blue;padding-left: 2em; padding-right: 2em;">
     ...
     <%
         ResultSet rset1=bean.rules(request);
 ...
 %>
    ...
    <br><h3 align="left"><b><i>Rules For <%=rset1.getString(1)%> -</i></b></h3>
    <p align="left">
    <%=rset1.getString(3)%>
    </p>
    <h3 align="left"><b><i><%=rset1.getString(1)%> Negative Marking concept</i></b></h3>
<p align="left"><%=rset1.getString(4)%>
    <br>
<%=rset1.getString(5)%>
</p>
<form name="reg" action="exam.jsp">
<!--<%//session.setAttribute("exam1",exam1);%>-->
<center><table style="width:900px;font-size:20px;">
<tr>
<td align="center" style="padding-bottom:1em;">
<input type="submit" value="Start Exam"></td></tr>
</table></center>
