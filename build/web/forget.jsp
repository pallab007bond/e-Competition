...
<body>
	...
	<div class="contact">
		<section id="banner">
<header>
<h2>Have you <strong>Forgotten your Password!</strong>.</h2>
<p>Please provide your <strong>Registered Email </strong>to get it back!
</p>
<br>
<form method="post" action="forgetpas.jsp">
<center><table style="width:700px;font-size:20px;">
        
<tr><td style="vertical-align:middle;"><strong>Your Registered Email</strong></td>
<td style="padding-bottom:1em;"><input type="email" name="email"></td></tr>

<tr><td></td>
<td align="right" style="padding-bottom:1em;"><input type="submit" value="Proceed"></td></tr>
